...
@RoutePage()
class MergeNumbersWinScreen extends StatefulWidget {
  final int score;
  const MergeNumbersWinScreen({super.key, required this.score});

  @override
  State<MergeNumbersWinScreen> createState() => _MergeNumbersWinScreenState();
}

class _MergeNumbersWinScreenState extends State<MergeNumbersWinScreen> {
  @override
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      context
                          .read<CoinsBloc>()
                          .add(AddCoinsEvent(coins: widget.score));
