...
@RoutePage()
class MergeCardsWinScreen extends StatefulWidget {
  final int coins;
  const MergeCardsWinScreen({super.key, required this.coins});

  @override
  State<MergeCardsWinScreen> createState() => _MergeCardsWinScreenState();
}

class _MergeCardsWinScreenState extends State<MergeCardsWinScreen> {
  @override
